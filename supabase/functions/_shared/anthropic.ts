...
//
// Model choice: claude-sonnet-5 for both AI features (Anthropic's most agentic Sonnet, released
// 2026-06-30; cost-aware — same $3/$15 standard price as Sonnet 4.6, and $2/$10 introductory
// through 2026-08-31; see ADR-0015). MAX_TOKENS is intentionally small to bound output-token cost
