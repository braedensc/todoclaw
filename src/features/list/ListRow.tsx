...
export function ListRow({
  ...
  const trailing = (
    <>
      ...
      {/* ONE trailing badge, by lane: the recurring status, the azure "❄️ Stale · 21d" a long-
          ignored one-off cools into, or the warm due chip while the deadline still means
          something. */}
      {status ? (
