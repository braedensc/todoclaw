  ...
  return (
    <>
      {isMobile ? (
        ...
        // (The FeatureTour's habits panel points at THIS component — but at the copy the DemoScene
        // mounts over seeded example habits, never the real shell's. Same reason the demo seeds them
        // at all: this row renders nothing for a habit-less new user, i.e. the tour's whole
        // audience, so there'd be nothing to spotlight.)
