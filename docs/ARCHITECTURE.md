...
| [ADR 2026-08-26](adr/2026-08-26-config-anchor-and-human-signal-guards.md) | 2026-08-26 | The git ref store becomes human-only (config anchor), and a session may not apply a protected label or approve a PR — three kit guards ported down |
...
| [ADR 2026-09-06](adr/2026-09-06-delegation-bound-dispatch.md) | 2026-09-06 | The `local-daemon` backend binds sessions by Linear delegation, not a pin file; the pinned-only guards fail open on that lane by design, and none of the pin machinery is retired |
